...
class CommandQueryBuilder
{
    public function paginate(Request $request): array
    {
        ...
        $jsonQuery = $this->buildJsonCommandQuery($includeAll, $onlyTrashed);
        $analogQuery = $this->buildAnalogCommandQuery($includeAll, $onlyTrashed);
        ...
        $data = $rows->map(function ($row) {
            ...
            return [
                ...
                'node_extended_id' => $row->node_extended_id ? (string) $row->node_extended_id : null,
    ...
    private function buildJsonCommandQuery(bool $includeAll, bool $onlyTrashed)
    {
        $jsonQuery = DB::table('control_json_commands as cjc')
            ...
            ->selectRaw("
                ...
                n.external_id as node_extended_id,
    ...
    private function buildAnalogCommandQuery(bool $includeAll, bool $onlyTrashed)
    {
